...
<table class="table">
	...
	<tr>
		...
		<td>
			<table class="table">
				<?php $_foreach_vv_counter = 0; $_foreach_vv_total = count($v);?><?php foreach( $v as $vk => $vv ) : ?><?php $_foreach_vv_index = $_foreach_vv_counter;$_foreach_vv_iteration = $_foreach_vv_counter + 1;$_foreach_vv_first = ($_foreach_vv_counter == 0);$_foreach_vv_last = ($_foreach_vv_counter == $_foreach_vv_total);$_foreach_vv_counter++;?>
				<tr>
